...
module_configuration = [
    ...
    },
    {
        ...
        "default": "{% if nb_analyzer_reports %}\n<div class=\"row\">\n    <div class=\"col-12\">\n        "
                   ...
                   "class=\"card\">\n                <div class=\"card-header collapsed\" id=\"drop_r_intelowl\" "
                   "data-toggle=\"collapse\" data-target=\"#drop_raw_intelowl\" aria-expanded=\"false\" "
                   "aria-controls=\"drop_raw_intelowl\" role=\"button\">\n                    <div "
                   "class=\"span-icon\">\n                        <div class=\"flaticon-file\"></div>\n               "
                   "     </div>\n                    <div class=\"span-title\">\n                        intelowl raw "
                   "results\n                    </div>\n                    <div class=\"span-mode\"></div>\n        "
                   "        </div>\n                <div id=\"drop_raw_intelowl\" class=\"collapse\" "
                   "aria-labelledby=\"drop_r_intelowl\" style=\"\">\n                    <div class=\"card-body\">\n  "
                   "                      <div id='intelowl_raw_ace'>{{ results|default(\"\")|tojson(indent=4) "
                   "}}</div>\n                    </div>\n                </div>\n            </div>\n        "
                   "</div>\n    </div>\n</div> \n<script>\nvar intelowl_in_raw = ace.edit(\"intelowl_raw_ace\","
                   "\n{\n    autoScrollEditorIntoView: true,\n    minLines: 30,\n});\nintelowl_in_raw.setReadOnly("
